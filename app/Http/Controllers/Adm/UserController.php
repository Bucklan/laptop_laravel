...
class UserController extends Controller
{
    ...
    public function confirm(Cart $cart)
    {
        ...
        return back()->with('messsages',__('cart.zakaz satti otti'));
    }

    public function cart()
    {
        $laptopsInCart = Cart::where('status', 'ordered')->with(['laptop', 'user'])->get();
        return view('adm.cart', ['laptopsInCart' => $laptopsInCart]);
    }
